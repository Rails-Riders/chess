...
class PawnTest < ActiveSupport::TestCase
  ...
  def setup
    @game = Game.create
    @white_pawn = @game.pieces.find_by(type: "Pawn", x_position: 1,
      y_position: 2, color: 1)
    @black_pawn = @game.pieces.find_by(type: "Pawn", x_position: 1,
      y_position: 7, color: 0)
  end
  ...
  test "can only capture unfriendly diagonally" do
    ...
    black_pawn_2 = @game.pieces.find_by(type: "Pawn", x_position: 7,
      y_position: 7, color: 0)
  ...
  test "check all capturing moves of a friendly with valid_move?" do
    ...
    white_pawn_2 = @game.pieces.find_by(type: "Pawn", x_position: 5,
      y_position: 2, color: 1)
